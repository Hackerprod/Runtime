...
def build_session(args):
    ...
    try:
        ...
        if args.backend == "original" and (threads != 1 or cpus is not None or row_weights is not None or selective_logits or diagnostics or reuse_kv or v_blocked_attention or ffn_row4):
